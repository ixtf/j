...
import com.gitee.ixtf.core.objectMap
import java.io.File
...
fun File.mainName(): String = J.mainName(this)

fun Path.mainName(): String = J.mainName(toFile())

fun File.extName(): String = J.extName(this)

fun Path.extName(): String = J.extName(toFile())
